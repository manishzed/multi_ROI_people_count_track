...
while True:
    ...
    if ret:
        ...
        cv2.putText(img_f, opc_txt1, (850, 100), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255), 1)

        #count current perosn count and total person count---zone 2
        opc_count2 = len(objectId_list2)
        opc_txt2 = "Zone-2: {}".format(opc_count2)
        cv2.putText(img_f, opc_txt2, (850, 120), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255), 1)
